  ...
  include:
    ...
    - stage: "Build Lab 4."
      ...
      install:
        - cd ./lab4/
      script:
        - docker build -t vlad5841/lab4:django-travis .
        - docker images
...
```text
    - stage: "Build Lab 4."
      ...
      install:
        - cd ./lab4/
      script:
        - docker build -f Dockerfile -t vlad5841/lab4:django-travis .
        - docker build -f Dockerfile.site -t vlad5841/lab4:monitoring-travis .
        - docker images
...
```text
    - stage: "Build Lab 5."
      ...
      script:
        ...
        - make docker-push
```
* ##### Посилання на мій [***Travis***](https://app.travis-ci.com/github/vlad13578/12345) білд.
